...
def evaluate(data, model, onset_threshold=0.01, frame_threshold=0.08, save_path=None):
    ...
    for label in data:
        ...
        p_ref, i_ref = extract_notes(label['frame'])
        p_est, i_est = extract_notes(pred['frame'], onset_threshold, frame_threshold)
