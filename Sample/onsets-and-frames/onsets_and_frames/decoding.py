...
def extract_notes(frames, onset_threshold=0.5, frame_threshold=0.5):
    """
    ...
    """
    print (np.max(frames.cpu().numpy()), np.min(frames.cpu().numpy()))
...
#     """
#     print (np.max(frames.cpu().numpy()), np.min(frames.cpu().numpy()))
#     print (np.max(onsets.cpu().numpy()), np.min(frames.cpu().numpy()))
